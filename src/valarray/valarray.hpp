...
_GLIBCXX_VISIBILITY(default) {
	...
	template<class _Oper, template<class, class > class _Meta1, template<class,
			class > class _Meta2, class _Dom1, class _Dom2>
	class _BinClos;
...
#include "bits/valarray_array.hpp"
#include "bits/valarray_before.hpp"
...
#include "bits/valarray_after.hpp"
#include "bits/slice_array.hpp"
#include "bits/gslice.hpp"
#include "bits/gslice_array.hpp"
#include "bits/mask_array.hpp"
#include "bits/indirect_array.hpp"
...
inline valarray<_Tp>::valarray(const slice_array<_Tp>& __sa) :
	...
	std::__valarray_copy_construct(__sa._M_array, __sa._M_sz, __sa._M_stride,
			_Array<_Tp>(_M_data));
}

template<typename _Tp>
inline valarray<_Tp>::valarray(const gslice_array<_Tp>& __ga) :
		_M_size(__ga._M_index.size()), _M_data(
				__valarray_get_storage<_Tp>(_M_size)) {
	std::__valarray_copy_construct(__ga._M_array, _Array<size_t>(__ga._M_index),
...
inline valarray<_Tp>::valarray(const mask_array<_Tp>& __ma) :
	...
	std::__valarray_copy_construct(__ma._M_array, __ma._M_mask,
			_Array<_Tp>(_M_data), _M_size);
}
...
inline valarray<_Tp>::valarray(const indirect_array<_Tp>& __ia) :
	...
	std::__valarray_copy_construct(__ia._M_array, __ia._M_index,
			_Array<_Tp>(_M_data), _M_size);
}
...
template<typename _Tp>
inline valarray<_Tp>::~valarray() _GLIBCXX_NOEXCEPT
{
...
valarray<_Tp>::operator=(const slice_array<_Tp>& __sa) {
	...
	std::__valarray_copy(__sa._M_array, __sa._M_sz, __sa._M_stride,
			_Array<_Tp>(_M_data));
	return *this;
}
...
valarray<_Tp>::operator=(const mask_array<_Tp>& __ma) {
	...
	std::__valarray_copy(__ma._M_array, __ma._M_mask, _Array<_Tp>(_M_data),
			_M_size);
	return *this;
}
...
valarray<_Tp>::operator=(const indirect_array<_Tp>& __ia) {
	...
	std::__valarray_copy(__ia._M_array, __ia._M_index, _Array<_Tp>(_M_data),
			_M_size);
	return *this;
}
...
template<typename _Tp>
inline _Expr<_SClos<_ValArray, _Tp>, _Tp> valarray<_Tp>::operator[](
		slice __s) const {
...
template<typename _Tp>
inline _Expr<_GClos<_ValArray, _Tp>, _Tp> valarray<_Tp>::operator[](
		const gslice& __gs) const {
...
template<typename _Tp>
inline valarray<_Tp> valarray<_Tp>::operator[](
	...
	for (size_t __i = 0; __i < __e; ++__i)
		if (__m[__i])
			++__s;
	return valarray<_Tp>(
			mask_array<_Tp>(_Array<_Tp>(_M_data), __s, _Array<bool>(__m)));
}
...
template<typename _Tp>
inline _Expr<_IClos<_ValArray, _Tp>, _Tp> valarray<_Tp>::operator[](
...
template<typename _Tp>
inline indirect_array<_Tp> valarray<_Tp>::operator[](
...
template<class _Tp>
inline _Expr<_ValFunClos<_ValArray, _Tp>, _Tp> valarray<_Tp>::apply(
		_Tp func(_Tp)) const {
...
template<class _Tp>
inline _Expr<_RefFunClos<_ValArray, _Tp>, _Tp> valarray<_Tp>::apply(
